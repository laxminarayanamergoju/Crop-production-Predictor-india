        ...
        <nav className=" navbar fixed-top navbar-expand-lg " style={{ backgroundColor: `${(window.innerWidth<1000?"#050816":(scrolled?"#050816":"transparent"))}`}}>
            <div className="container-fluid">
                ...
                <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <Link style={{color:"white"}} className={`nav-link me-3 pl-3 ${isActive('/') ? 'active' : ''}`} aria-current="page" to="/" replace={true}>&nbsp;&nbsp;</Link>
                    </li>
                    <li className="nav-item">
                    <Link  style={{color:"white"}} className={`nav-link me-5 pl-3 ${isActive('/about') ? 'active' : ''}`} aria-current="page" to="/about">&nbsp;&nbsp;</Link>
                    </li>
